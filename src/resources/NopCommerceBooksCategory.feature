Feature: Books Category
  ...
  Scenario Outline: I should be able to chosoe any filter option with specific result
    Given I am on book page
    When I click on "<filter>"
  ...
  Scenario Outline: I should be able to see product display format according to display format as per given in picture in SRS document
    Given I am on book category page
    When I click on "<Display format icon>"
    Then I should be able to see product display format according to display format type as per given picutre is SRS document
    Examples:
      | Display format icon |
      | Grid                |
      | List                |